...
| $\textcolor{red}{\text{TryHackMe}}$   | $\textcolor{red}{\text{Input Manipulation and Prompt Injection}}$              | $\textcolor{red}{\text{Prompt Injection, LLM vulnerabilities}}$                       | [IMPI Writeup](TryHackMe-Input-Manipulation-and-Prompt-Injection.pdf) |
...
| $\textcolor{blue}{\text{Hack The Box}}$ | $\textcolor{blue}{\text{MangoBleed}}$ | $\textcolor{blue}{\text{log analysis}}$ | [MangoBleed Writeup](HackTheBox-MangoBleed.pdf) |
